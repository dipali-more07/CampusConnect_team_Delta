...
export default function OrganizerViewModal({
  ...
  useEffect(() => {
    if (viewOrg && dialogRef.current && !dialogRef.current.open) {
  ...
  return createPortal(
    ...
    >
      ...
      >
        <div
          className="pointer-events-auto rounded-[24px] w-full max-w-[420px] overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="flex items-center justify-between px-7 py-5" style={{ borderBottom: `1px solid ${tokens.border}` }}>
            ...
            <button
              type="button"
              onClick={() => setViewOrg(null)}
              className="w-8 h-8 rounded-full border-none bg-transparent cursor-pointer flex items-center justify-center p-0"
          ...
          <div className="px-7 py-6 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              <div className="rounded-xl p-3" style={{ background: tokens.hoverBg }}>
                <p className="text-[11px] font-bold m-0 mb-0.5 font-sans" style={{ color: tokens.txtSec }}>Department</p>
                <p className="text-[13px] font-bold m-0" style={{ color: tokens.txtPri }}>{viewOrg.department}</p>
              </div>
              <div className="rounded-xl p-3" style={{ background: tokens.hoverBg }}>
                <p className="text-[11px] font-bold m-0 mb-0.5 font-sans" style={{ color: tokens.txtSec }}>College ID</p>
              ...
              <div className="rounded-xl p-3 col-span-2" style={{ background: tokens.hoverBg }}>
                <p className="text-[11px] font-bold m-0 mb-0.5 font-sans" style={{ color: tokens.txtSec }}>Office Address</p>
              ...
              <div className="rounded-xl p-3 col-span-2" style={{ background: tokens.hoverBg }}>
                <p className="text-[11px] font-bold m-0 mb-0.5 font-sans" style={{ color: tokens.txtSec }}>Contact Number</p>
                <div className="flex items-center gap-1.5 mt-0.5" style={{ color: tokens.txtPri }}>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl" style={{ border: `1px dashed ${tokens.border}` }}>
              ...
              <a href={`mailto:${viewOrg.email}`} className="text-[13px] font-bold transition-colors font-sans" style={{ color: BRAND }}>
                {viewOrg.email}
              </a>
            </div>
          </div>

...
async def main():
    print("---------------------------------------------")
    print("[START] CampusConnect SMTP Email Service Tester")
    print("---------------------------------------------")
    ...
    print(f"MOCK_EMAIL:    {settings.MOCK_EMAIL}")
    print("---------------------------------------------")
    
    if not settings.MAIL_USERNAME or not settings.MAIL_PASSWORD:
        print("[WARNING] SMTP credentials are not set in your .env file!")
    ...
    if success:
        if not settings.MAIL_USERNAME or settings.MOCK_EMAIL:
